...
/**
 * Sketch class of interactive story game Ibong Adarna, where the player can make decisions that change the final outcome and
...
public class MySketch extends PApplet {
    PApplet app; //The canvas used to display graphical elements
    Player player; //Player object representing character
    Game currentGame; //Current minigame being played
    ArrayList<Game> gameResults; //Array list of all the players' game results
    ...
    int[][] gamePositions = {{279, 229}, //Names
                             ...
                             {414, 349},
                             {414, 389},
                             {553, 229}, //Attribute specific to minigame
                             {553, 269},
                             {553, 309},
                             {553, 349},
                             {553, 389},
    ...
    /**
     * Setup values before graphics begin (text size, clear player data file, load images)
     */
    public void setup() {
    ...
    public void draw() {
        ...
        //Check if the game is paused
            ...
            text(player.getHealth() + " / " + player.getFullHealth(), 371, 242); //Display player's current health
            text(player.getInventory().getNumFood(), 460, 280); //Display the number of food items in the player's inventory
            text(Player.getHealthPerFood() + " HP", 447, 312); //Display the number of health points each food item is worth
        ...
        //If the player is still alive and the game is not paused, continue drawing the story/game    
            ...
            //Leaderboard
                ...
                if (Player.getNumPlayers() > 0) {
                    ...
                    } //End for loop going through each player
            ...
            //Encounter Boar
                ...
                //Display instructions for boar fight minigame
                    ...
                    //Set background to boar fight minigame instructions
            ...
            //Walking in the Forest 1
                ...
                //Once player passes the right edge of the screen
                if (player.x > 800) { 
                    player.moveTo(85, 240); //Set new player position
                    stage = 7; //Go to the next stage (Meet Hermit)
                } //End if statement checking if player has gone off the screen
            ...
            //Catch the Adarna Bird
                ...
                } //End if statement checking if the player has the rope and golden cage, which determines what is shown on the screen
            ...
            //Betrayal
                ...
                if (currentScreen14 == 1) {
                    //Set background to when brothers take the Adarna bird
                    background(betrayalBG1); 
            ...
            //Escaped Well
                ...
                //If player just escaped from the well
                ...
                } //End if statement checking which screen to show for Stage 16
            ...
            //Heal King
                ...
                } //End if statement checking which screen to show for Stage 18
            ...
            } //End if statement for displaying the heart/pause/healing button

        } //End if statement checking for player death/game paused/story continuing
    } //End draw method
    
    
    /**
     * Updates variables that indicate that the player's mouse is currently over a certain button, which are used to determine
     * when a button (image) is clicked in the game
     * 
    ...
    void update(int x, int y) {
        ...
        //For all stages that display the heart/pause/healing button
        if (stage == 2 || stage == 3 || stage == 4 || stage == 6 || stage == 7 || stage == 8 || stage == 9 || stage == 12 || stage == 13 || stage == 14 || stage == 16 || stage == 17) {
            //Set boolean variable of heart/pause/healing button to true if the mouse is over it (used for button clicks)
            if (overImage(heartButton, heartX, heartY)) { 
                overHeart = true; //Set variable indicating mouse is over heart/pause/healing button to true
                return; //Exit method
            } //End if statement checking if the mouse is over the heart/pause/healing button
        } //End if statement checking the stages that display the heart/pause/healing button
    
        //For boolean variables of buttons when the game is paused        
        if (gamePaused) {
        ...
        //For boolean variables of buttons during the story's progression
        } else {
            //Stage 0 (Main Menu)
            if (stage == 0) {
            ...
            //Stage 11 (Catch the Adarna Bird)
                ...
                } //End if statement checking if the player has rope and golden cage in their inventory
            ...
            } //End if statement checking the current stage in the story game (when the game is not paused)
            
        } //End if statement checking if game is paused or the story is progressing
    } //End update method
    
    
    @Override
    /**
     * Method run when the player clicks on the screen
     */
    public void mousePressed() {
        ...
        if (stage == 2 || stage == 3 || stage == 4 || stage == 6 || stage == 7 || stage == 8 || stage == 9 || stage == 12 || stage == 13 || stage == 14 || stage == 16 || stage == 17) {
            ...
            if (overHeart) {
                ...
                return; //Exit method
            } //End if statement checking if the mouse is over heart/pause/healing button when mouse is clicked
        } //End if statement checking the stages that display the heart/pause/healing button
        
        //For mouse clicks when the game is paused
        if (gamePaused) {
        ...
        //For mouse clicks during the story's progression
        } else {
            //Stage 0 (Main Menu)
            if (stage == 0) {
                ...
                } //End if statement checking which button the mouse is over
            ...
            //Stage 11 (Find Adarna)
                ...
                if (overAdarnaBird) {
                    ...
                    stage = 12; //Go to the next stage (Caught Bird) 
                } //End if statement checking if mouse is over Adarna bird
            ...
            } //End if statement checking which stage it is when the mouse is clicked
    ...
    @Override
    /**
     * Method run when the player presses keys on the keyboard
     */
    public void keyPressed() {
        ...
        if (key == ' ') {
            ...
            //Spacebar is pressed when game is not paused and the story is progressing
            } else {
                ...
                //Spacebar is pressed in Stage 1 (Begin Story)
                    ...
                    //If screen currently being shown is the first part of the story introduction
                    if (currentScreen1 == 1) 
                        currentScreen1 = 2; //Go to next screen (second part of story introduction)
                    
                    //If screen currently being shown is the second part of the story introduction
                    else if (currentScreen1 == 2) 
                        currentScreen1 = 3; //Go to next screen (character traits distribution)
                    
                    //If screen currently being shown is the character traits distrubution
                    else if (currentScreen1 == 3) { 
                        ...
                        //If user has distributed both of their points
                        } else { 
                        ...
                        } //End if statement checking if the player has distributed both of their points
                        
                    //If screen currently being shown is the first part of the game instructions
                    } else if (currentScreen1 == 4) {
                        currentScreen1 = 5; //Go to next screen (second part of the game instructions)
                    
                    //If screen currently being shown is the second part of the game instructions
                    } else { 
                ...
                //Spacebar is pressed in Stage 4 (Encounter boar)
                    ...
                    //If screen currently being shown is the encounter with the boar
                    if (currentScreen4 == 1) { 
                        //If user chose path with boar
                        if (willFightBoar) { 
                            currentScreen4 = 2; //Display boar fight minigame instructions
                        //If user chose path without boar 
                        } else { 
                            player.moveTo(85, 240); //Set new player position
                            stage = 7; //Go to the next stage (Meet Hermit)
                        } //End if statement for if user chose path with the boar
                        
                    //If screen currently being shown is the boar fight minigame instructions
                    } else if (currentScreen4 == 2){ 
                ...
                //Find Brothers
                    ...
                    } //End if statement checking if current screen of Stage 13 is 1 or 3

                //Spacebar is pressed in Stage 14 (Betrayal)
                } else if (stage == 14) {
                    //If screen currently being shown is when the brothers take the Adarna bird
                    if (currentScreen14 == 1) 
                        currentScreen14 = 2; //Go to next screen (push player down the wall)
                    
                    //If screen currently being shown is the brothers leaving the player
                    else if (currentScreen14 == 3) 
                        currentScreen14 = 4; //Go to next screen (well minigame instructions)
                    
                    //If screen currently being shown is the well minigame instructions
                    else if (currentScreen14 == 4){ 
                ...
                //Spacebar is pressed in Stage 18 (Heal King)
                    ...
                    //If screen currently being shown is when player decided to save their brothers and just arrived back at the palace
                    if (currentScreen18 == 1) 
                        currentScreen18 = 2; //Go to the next screen
                    //If screen currently being shown is when player decided to save their brothers and the bird heals the king
                    else if (currentScreen18 == 2) 
                        currentScreen18 = 3; //Go to the next screen
                    //If screen currently being shown is when player decided to leave their brothers and just arrived back at the palace
                    else if (currentScreen18 == 4) 
                        currentScreen18 = 5; //Go to the next screen
                    //If screen currently being shown is when player decided to leave their brothers and the bird heals the king
                    else if (currentScreen18 == 5) 
                        stage = 19; //Go to the next stage (Ending)
                ...
                } //End if statement checking which stage it is when the spacebar is pressed
                
            } //End if statement checking if game was paused or if the story is progressing
        } //End if statement checking if the spacebar is pressed
        ...
        } //End if statement going through stages that use specific keys to indicate events   
    ...
    * @param y      Y position of button (image)
    * @return       Returns true if mouse is over button
    */
   boolean overImage(PImage image, int x, int y)  {
        //If mouse is over the specified button (image)
        ...
        } //End if statement checking if mouse is over button (image)
    } //End over image method
   
   
   /**
    * Method called once a game ends, either by player death or completion of the story, in order to reset all game variables, 
    * write player data to the flat file, and return to the main menu
    */
    ...
    /**
     * Method called to reset all variables related to the game, once a game ends
     */
    public void resetGame() {
        ...
        //Reset variables for Stage -3 (Customize Clothes)
        ...
        //Reset variables for Stage 1 (Begin Story)
        ...
        //Reset variables for Stage 4 (Encounter Boar)
        currentScreen4 = 1; //Current screen being shown in Stage 4
        //Reset variables for Stage 7 (Meet Hermit)
        currentScreen7 = 1; //Current screen being shown in Stage 7
        //Reset variables for Stage 9 (Find Adarna bird)
        currentScreen9 = 1; //Current screen being shown in Stage 9
        //Reset variables for Stage 11 (Catch the Adarna Bird)
        ...
        //Reset variables for Stage 13 (Find Brothers)
        ...
        //Reset variables for Stage 14 (Betrayal)
        currentScreen14 = 1; //Current screen being shown in Stage 14
        //Reset variables for Stage 16 (Escaped Well)
        currentScreen16 = 1; //Current screen being shown in Stage 16
        //Reset variables for Stage 18 (Heal King)
        currentScreen18 = 1; //Current screen being shown in Stage 18
    } //End reset game method
   

   /**
    * Iterates through all of the previously created Game objects (Boar/Rhythm/Well) from when the minigames were played and 
    * displays the data all of the BoarFightGame objects (minigame results) on the screen
    * 
    * @param gamesPlayed  ArrayList of Game objects that stores all of the minigames played by all of the players
    */
   ...
   } //End display boar game results method
   
   
   /**
    * Iterates through all of the previously created Game objects (Boar/Rhythm/Well) from when the minigames were played and 
    * displays the data all of the RhythmGame objects (minigame results) on the screen
    * 
    * @param gamesPlayed  ArrayList of Game objects that stores all of the minigames played by all of the players
    */
   ...
   } //End display rhythm game resutls method
    
    
   /**
    * Iterates through all of the previously created Game objects (Boar/Rhythm/Well) from when the minigames were played and 
    * displays the data all of the EscapeWellGame objects (minigame results) on the screen
    * 
    * @param gamesPlayed  ArrayList of Game objects that stores all of the minigames played by all of the players
    */
   ...
   } //End display well game results method
